...
public class CourseParser {
	private static CourseList schedule = new CourseList(); // manipulates a
	...
	public static CourseList toCourseList(String s) {
		...
		while (s.length() - 1 > temp) {// shrink string until its the last value
			...
			schedule.addCourse(toCourse(a));
		}
		schedule.addCourse(toCourse(s.substring(0, findNextPos3(s))));
	...
	private static Course makeCourse(String s, char type) {
		...
		case 'L':
			...
			break;
		case 'D':
			c = new Discussion(info, schedule.findLecture(info));
			c.setCourseID(id);
			break;
		case 'l':
			c = new Lab(info, schedule.findLecture(info));
			c.setCourseID(id);
			break;
		default:
...
//		 sched.addCourse(temp3);
//		System.out
//				.println("[|l|0|test|testy|proftest|0 2 4|section|1111|12|1|false|, |l|0|test|testy|proftest|0 2 4|section|1111|12|1|false|, |L|0|test|testy|proftest|0 2 4|section|1111|12|1|false|, |D|0|test|testy|proftest|0 2 4|section|1111|12|1|false|, |l|0|test|testy|proftest|0 2 4|section|1111|12|1|false|, |L|0|test|testy|proftest|0 2 4|section|1111|12|1|false|, |D|0|test|testy|proftest|0 2 4|section|1111|12|1|false|]"
...
//		System.out
//				.println(toCourse("|l|0|test|testy|proftest|0 2 4|section|1111|12|1|false|"));
