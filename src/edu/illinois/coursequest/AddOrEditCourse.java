...
public class AddOrEditCourse extends Activity {
	...
	CourseList temp = CourseQuest.getSched();
	if (info == null) {
	    ...
	    temp.addCourse(info, type);
	} 
        else { // edit course
	    temp.editCourse(courseToEdit, info);
	}
	CourseQuest.model.add(info, type);
