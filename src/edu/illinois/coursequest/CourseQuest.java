...
import edu.illinois.sql.CourseModel;
...
public class CourseQuest extends TabActivity {
    /**
     * TODO set up saving and loading... TODO set up the sqi database
     */
    ...
    public static CourseModel model;
	...
	Course.setCount(0); //reset count/colors
	cursor = model.getAllOrdered();
	for(int i = 0; i < cursor.getCount(); i++){
	    CourseInfo info = model.getCourseInfo(i);
	    sched.addCourse(info, model.getCourseType(i));
	}
   }
